...
fileList = glob.glob('/well/bag/deyre/analysis/spades-flow/replicates_output/*/*_kraken.txt')

outfile = '/well/bag/deyre/analysis/spades-flow/replicates_kraken_summary.txt'
o = open(outfile, 'w')
