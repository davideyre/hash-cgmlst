...
def compareHash(input_folder, compareOut):
	...
	excludeList = ['CD630_16790', 'CD630_14380', 'CD630_17540', 'CD630_24440', 'CD630_13240', 'CD630_16000', 'CD630_32680', 'CD630_20520', 'CD630_20910', 'CD630_25780']
	...
	for i in range(0, len(jsonList)):
		...
		for j in range(0, len(jsonList)):
			if i<j:
				a2 = [jsonList[j]['alleles'][k] for k in jsonList[i]['alleles'].keys() if k not in excludeList]
				compared = 0
				diff = 0
